...
<%
 ...
 boolean isCheckboxChecked = false;
    ...
    <h2 class="site_main">공지사항</h2><br>

  <div id="free55">
        <div class="row">
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 100%;border-radius:15px 15px 15px 15px;">
                <thead>
                    <tr>
                        <th colspan="2" style="background-color: #eeeeee; text-align: center;border-radius:10px 10px 10px 10px;">게시판 글 보기</th>
                    </tr>
                </thead>
                <tbody>
                    <%
...
//alert("<%=Post.getThum()%>");
            ...
            <a href="Untitled-5.jsp" class="btn btn-primary"><button class="jelly">목록</button></a>

			<!-- 해당 글의 작성자가 본인이라면 수정과 삭제가 가능하도록 코드 추가 -->
			<%
				if(userID != null && userID.equals(Post.getUser_id())){
			%>
					<a href="updatewrite4.jsp?idx=<%= idx %>" class="btn btn-primary"><button class="jelly">수정</button></a>
