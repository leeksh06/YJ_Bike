...
<td colspan="2">
    ...
    %>
            ...
            <a href="MyInfoBoard.jsp" class="btn btn-primary"><button class="jelly">목록</button></a>

			<!-- 해당 글의 작성자가 본인이라면 수정과 삭제가 가능하도록 코드 추가 -->
			<%
				if(userID != null && userID.equals(Post.getUser_id())){
			%>
					<a href="update3.jsp?idx=<%= idx %>" class="btn btn-primary"><button class="jelly">수정</button></a>
...
<%
  ...
  <% String nickname = (String) session.getAttribute("nickname"); %>
    <h2>환영합니다!<br><%= (nickname != null) ? nickname : "불러오기실패" %>님</h2>
     <form method="post" action="logoutAction8.jsp" id="login-form">
