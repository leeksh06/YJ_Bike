 ...
 boolean isCheckboxChecked = false;
    ...
    <header id="header">
	 ...
	 <nav id="nav">
    	...
    	<button class="btn btn-write" id="writeButton" onclick="handleWriteButtonClick();" style="margin-top:5px;">글쓰기</button>
        ...
        <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 99.8%;">
                ...
                <tr>
                  ...
                  <td><a href="View2.jsp?idx=<%= list.get(i).getIdx() %>">
                         <%= list.get(i).getTitle()%>
                       </a></td>
           ...
           <div>
                <ul style="list-style-type: none;">
                    ...
                    <li style="display: inline;">
                        <a href="Untitled-4.jsp?pageNumber=<%=i%>&category=<%=category%>"><%=i%></a>
                    </li>
                    <% } %>
                </ul>
            </div>
  ...
  function checkSearch() {
    ...
    function handleWriteButtonClick() {
      ...
      if (userID === null || userID === "" || userID === "null") {
        ...
        window.location.href =  "write_S.jsp?category=use";
      } else {
