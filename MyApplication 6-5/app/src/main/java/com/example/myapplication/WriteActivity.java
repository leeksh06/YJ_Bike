...
public class WriteActivity extends AppCompatActivity {
    ...
    int views;
    String idx, user_id, category, title, content, thum, view, selectedCategory, getTime, id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (title_et.getText().toString().trim().equals("") ||
                    ...
                    Toast.makeText(WriteActivity.this, "모든 항목을 입력하세요", Toast.LENGTH_SHORT).show();
                } else {
        ...
        write_btnPickImage = findViewById(R.id.write_btnPickImage);
        recyclerView = findViewById(R.id.write_imageRecycler);

        imageAdapter = new WriteRecyclerViewAdapter(this, imageDataArrayList);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, RecyclerView.HORIZONTAL, false));
        recyclerView.setAdapter(imageAdapter);

        write_btnPickImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//        String url = "http://10.0.2.2:8080/android/uploadImage.jsp";
    ...
    public void sendRequest() {
        String url = "http://172.245.179.217:8080/htdocs/cap/writeProcess.jsp";
        //String url = "http://10.0.2.2:8000/cap/writeProcess.jsp";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        if (currentActivity.equals("PostActivity")) {
                            intent = new Intent(WriteActivity.this, PostActivity.class);
                            intent.putExtra("category", category);
                        } else if (currentActivity.equals("list5Activity")) {
                            intent = new Intent(WriteActivity.this, list5Activity.class);
                        } else {
                            intent = new Intent(WriteActivity.this, RankingActivity.class);
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<String, String>();
                // params.put("idx", String.valueOf(idx.getText()));
                params.put("user_id", String.valueOf(user.getText()));//user완료
                params.put("category", selectedCategory);//카테고리 완료
                params.put("title", String.valueOf(title_et.getText()));//제목 완료
                params.put("content", String.valueOf(content_et.getText()));//내용 완료
                params.put("date", String.valueOf(getTime));//날짜 완료
                params.put("views", String.valueOf(views));//날짜 완료
